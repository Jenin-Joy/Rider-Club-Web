...
<html>
    ...
    <body>
        ...
        <%
             ...
             {
                 String ins="insert into tbl_eventbooking(booking_totalticket,showroom_id,event_id,booking_totalamount,booking_date)values('"+request.getParameter("txttotal")+"','"+session.getAttribute("shroomid")+"','"+request.getParameter("hid")+"','"+request.getParameter("txttotalrate")+"',curdate())";
                 //out.println(ins);   
