...
<html>
    ...
    <body>
        <%
            ...
            {
                String ins="insert into tbl_complaint(complaint_condent,complainttype_id,showroom_id,complaint_date)values('"+request.getParameter("txtcomplaint")+"','"+request.getParameter("selcomplaint")+"','"+session.getAttribute("shroomid")+"',curdate())";
            //out.println(ins);
        ...
        <form id='tab'>
            <table align='center'>
                ...
                <tr><td colspan="2"><a href="ViewComplaint.jsp">View Replays</a></td></tr>
            </table>
        </form>
    </body>
</html>
