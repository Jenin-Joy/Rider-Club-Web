...
<html>
    ...
    <body>
        <%
            String sel1="",payment="";
            sel1="select * from tbl_partsbooking where showroom_id='"+session.getAttribute("shroomid")+"'";
        ...
        <form id="tab">
            <table  align="center" border="1">
                ...
                <%
                    int i=0;
                    String sel="select * from tbl_partsbooking  p inner join tbl_user u on p.user_id=u.user_id where showroom_id='"+session.getAttribute("shroomid")+"'";
