<%-- 
    Document   : Viewclub
    Created on : 24 Jan, 2021, 4:10:20 PM
    Author     : asus
--%>
...
<html>
    ...
    <body align="center">
            ...
            <form method="POST" id="tab">
                <table align="center" cellpadding="10" width="700">
                    <tr>
                        ...
                        <td width="250"><select name="selvecat"><option>..Select..</option>
                                <%
            ...
            <table border="1" align="center" cellpadding="10">                 
                ...
                <% 
                    int i=0;
                    String sel1="select * from tbl_club c inner join tbl_district d on d.district_id=c.district_id inner join tbl_clubtype ct on ct.clubtype_id=c.clubtype_id where user_id!='"+session.getAttribute("uid")+"'";
               ...
               <%
                        String selCount="select * from tbl_requestclub where club_id='"+ vc.getString("club_id") +"' and user_id='"+session.getAttribute("uid")+"'"; 
                        //out.print(selCount);
