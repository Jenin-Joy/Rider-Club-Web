...
<html>
    ...
    <body>
        ...
        <%
             ...
             {
                 String ins="insert into tbl_eventbooking(booking_totalticket,shop_id,event_id,booking_totalamount,booking_date)values('"+request.getParameter("txttotal")+"','"+session.getAttribute("shopid")+"','"+request.getParameter("hid")+"','"+request.getParameter("txttotalrate")+"',curdate())";
                 //out.println(ins);   
        ...
        <table  align="center">
            <tr>
                ...
                <td><input id="demoInput" autocomplete="off" type="number" onchange="ticrate()" value="1" min="1" max="<%=count%>" name="txttotal"></td>
            </tr>
            <tr>
